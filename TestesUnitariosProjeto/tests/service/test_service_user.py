...
class TestServiceUser():
    ...
    def test_add_user_success(self):
        ...
        # Chamada
        resultado = service.add_user("Cleonice", "Analista")
    ...
    def test_add_user_type_error(self):
        ...
        service.add_user("Cleonice", "Analista")

        # Chamada
        resultado = service.add_user("Cleonice", 50)
    ...
    def test_remove_user_success(self):
        ...
        # Chamada
        resultado = service.remove_user("Cleonice")
    ...
    def test_update_user_success(self):
        ...
        # Chamada
        resultado = service.update_user("Cleonice", "Desenvolvedor")
    ...
    def test_update_user_type_error(self):
        ...
        # Chamada
        resultado = service.update_user("Cleonice", [])
    ...
    def test_get_user_success(self):
        ...
        service = ServiceUser()
        service.add_user("Cleonice", "Analista")
        resultado_esperado = ("Cleonice", "Analista")

        # Chamada
        user = service.get_user_by_name("Cleonice")
